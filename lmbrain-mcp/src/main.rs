...
fn specific_status(name:&str)->Option<&'static str>{match name{"task_plan"=>Some("planned"),"task_start"|"spec_start"=>Some("in-progress"),"task_submit"|"spec_submit"=>Some("review"),"task_complete"=>Some("done"),"task_block"=>Some("blocked"),"task_cancel"=>Some("cancelled"),"spec_ready"=>Some("ready"),"spec_accept"|"review_accept"|"adr_accept"=>Some("accepted"),_=>None}}

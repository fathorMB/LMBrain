...
if (!cargoVersion || app.version !== cargoVersion || app.version !== kit) {
  throw new Error(`Version mismatch: package.json=${app.version}, Cargo.toml=${cargoVersion ?? "missing"}, kit=${kit}`);
}

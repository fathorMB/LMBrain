...
vi.mock("../lib/commands", () => ({
  ...
  getAgentImprovementInsights: vi.fn(async () => ({
    ...
    metrics: [{
      ...
      lifecycle_unknown_reviews: 0,
      lifecycle_coverage: 1,
      category_values: 3,
      canonical_category_values: 2,
      category_alias_values: 1,
      unknown_categories: ["project-specific"],
      category_coverage: 2 / 3,
      attribution_basis: "original-implementation-agent",
      confidence: "medium",
      diagnostics: ["unknown category"],

...
- **Experimental Wayfinder ([[contract/wayfinder.md]]):** Use only after explicit operator agreement for a multi-session uncertain route. Maps shape decisions; they never authorize implementation or replace specs, milestones, or reviews.
